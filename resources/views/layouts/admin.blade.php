            ...
            <div class="flex items-center justify-start">
                ...
                <a href='/' class="flex items-center">
                    <svg viewBox="0 0 316 316" xmlns="http://www.w3.org/2000/svg" class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200">
                        ...
                        <span class="ml-2 text-gray-800 dark:text-gray-200">My First Store</span>
                    </svg>
                </a>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                <div>{{ Auth::user()->first_name ?? 'Default Value' }}</div>
...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div id="sidebar" class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @role('admin')
            <li>
                <a href="/user" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <li>
                <a href="/inventary" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <path fill-rule="evenodd" d="M10 1a1 1 0 00-1 1v2h2V2a1 1 0 00-1-1zm0 4H7a1 1 0 00-1 1v11a1 1 0 001 1h6a1 1 0 001-1V6a1 1 0 00-1-1h-3zm-2 2H8v8H6V7zm4 0h2v8h-2V7zm3-2h2a1 1 0 00.707-.293l2-2a1 1 0 000-1.414l-2-2A1 1 0 0016 0h-2a1 1 0 00-1 1v2a1 1 0 001 1zM5 0H3a1 1 0 00-1 1v2a1 1 0 001 1h2a1 1 0 001-1V1a1 1 0 00-1-1z" clip-rule="evenodd" />
                    </svg>
                    <span class="flex-1 ml-3 whitespace-nowrap">Inventary</span>
                </a>
            </li>
            @endrole
            @guest
            ...
            @auth
                <li>
                    <a href="/purchased" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 4a3 3 0 00-3 3v6a3 3 0 003 3h10a3 3 0 003-3V7a3 3 0 00-3-3H5zm-1 9v-1h5v2H5a1 1 0 01-1-1zm7 1h4a1 1 0 001-1v-1h-5v2zm0-4h5V8h-5v2zM9 8H4v2h5V8z" clip-rule="evenodd"></path></svg>
